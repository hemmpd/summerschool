...
int main(int argc, char *argv[])
{
    ...
    /* define the datatype for the struct particle  using MPI_Type_create_struct
    ...
    */
    ...
    /* check extent (not really necessary on most platforms) That is,
    ...
    if (extent != (dist[1] - dist[0])) {
        /* resize particle type to correct extent */
